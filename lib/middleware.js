...
module.exports.filePath = function filePathMiddleare(req, res, next) {
  if (req.body.dir == null || req.body.path == null || req.body.name == null) {
    next({
      code: 400,
...
module.exports.newFilePath = function newFilePathMiddleare(req, res, next) {
  if (req.body.dir == null || req.body.path == null || req.body.newName == null && req.body.newPath == null) {
    next({
      code: 400,
      message: 'missing params'
    });
...
module.exports.dirty = function dirtyBuild (req, res, next) {
  build.dirty = true;
  next();
};